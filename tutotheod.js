        ...
        onEnteringState: function( stateName, args )
        {
            ...
            switch( stateName )
            {
                ...
                case 'newSquare':
                    ...
                    for (const [color, square] of Object.values(args.args.tokens)) {

                        token = document.getElementById('token_'+color);

                        console.log( 'Token '+color+' should be at '+square+' square:', token );
                    }
